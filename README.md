...
- `LESSONS_TRANSPORT=cli|api` – choose between the Claude CLI and the Anthropic Messages API.
...
| Command | Purpose |
| --- | --- |
| `uv run lessons-tk extract-prompts transcripts/all_sessions.json` | Rebuild `transcripts/user_prompts_only.txt` from Claude JSONL exports. |
